        ...
        <div className='bg-[#0f172a]'>
            ...
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="group flex flex-col h-full bg-white shadow-sm rounded-xl dark:bg-slate-900 dark:shadow-slate-700/[.7]">
                        ...
                        <div className="p-4 md:p-6">
                            ...
                            <p className="mt-3 text-gray-500">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium, facere? Expedita aspernatur esse amet, facilis numquam architecto corrupti excepturi, ut nemo id fuga tempora qui explicabo culpa a tenetur placeat.
                            </p>
                        </div>
                        <div className="mt-auto flex border-t border-gray-200 divide-x divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                            <a className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-es-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 cursor-pointer" onClick={()=>navigate('/learn/about-course')}>
                                View Course
                            </a>
                    ...
                    <div className="group flex flex-col h-full bg-white shadow-sm rounded-xl dark:bg-slate-900 dark:shadow-slate-700/[.7]">
                        ...
                        <div className="p-4 md:p-6">
                            ...
                            <p className="mt-3 text-gray-500">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quae, explicabo soluta consectetur doloremque fugiat a, illo nisi quam vel deserunt minus rem harum iusto aut, temporibus modi odio laborum nostrum.        </p>
                        </div>
                        <div className="mt-auto flex border-t border-gray-200 divide-x divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                    ...
                    <div className="group flex flex-col h-full bg-white shadow-sm rounded-xl dark:bg-slate-900 dark:shadow-slate-700/[.7]">
                        ...
                        <div className="p-4 md:p-6">
                            ...
                            <p className="mt-3 text-gray-500">
                               Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum totam placeat repudiandae eum repellendus perspiciatis necessitatibus accusamus excepturi iusto incidunt fugiat eligendi mollitia minus, saepe odit possimus quod, reiciendis numquam.
                            </p>
                        </div>
                        <div className="mt-auto flex border-t border-gray-200 divide-x divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                            <a className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-es-xl bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
