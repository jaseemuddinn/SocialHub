                            ...
                            <div className="p-4 sm:p-7">
                                <div className="text-center">
                                    ...
                                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <a onClick={()=> navigate('/signup')} className="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" >
                                            Sign up here
                                        </a>
                                    </p>
                                </div>
                                        ...
                                        <div className="grid gap-y-4">
                                            ...
                                            <div>
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <a onClick={()=>navigate('/resetpassword')} className="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Forgot password?</a>
                                                </div>
                                                <div className="relative">
